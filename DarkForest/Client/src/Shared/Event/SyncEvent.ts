...
import { EntityParam } from "../Model/EntityParam";
...
export class SyncEvent extends BaseEvent {
	...
	public static CreateEntity(type: string, param: EntityParam): void {
		let e = this.Get();
	...
	public static AddSyncProp(e: SyncEvent, attr: EAttr, value: any): void {
		e.attrs.push(attr);
