...
declare namespace RC.Numerics {
    class Mat2 {
        ...
        static Add(p1: Mat2, p2: Mat2): Mat2;
        static AddN(p1: Mat2, p2: number): Mat2;
        static Sub(p1: Mat2, p2: Mat2): Mat2;
        static SubN(p1: Mat2, p2: number): Mat2;
        static SubN2(p1: number, p2: Mat2): Mat2;
        static Mul(m1: Mat2, m2: Mat2): Mat2;
        static MulN(p1: Mat2, p2: number): Mat2;
        static Div(p1: Mat2, p2: Mat2): Mat2;
        static DivN(p1: Mat2, p2: number): Mat2;
        static DivN2(p1: number, p2: Mat2): Mat2;
...
declare namespace RC.Numerics {
    class Mat3 {
        ...
        static Add(p1: Mat3, p2: Mat3): Mat3;
        static AddN(p1: Mat3, p2: number): Mat3;
        static Sub(p1: Mat3, p2: Mat3): Mat3;
        static SubN(p1: Mat3, p2: number): Mat3;
        static SubN2(p1: number, p2: Mat3): Mat3;
        static Mul(m1: Mat3, m2: Mat3): Mat3;
        static MulN(p1: Mat3, p2: number): Mat3;
        static Div(p1: Mat3, p2: Mat3): Mat3;
        static DivN(p1: Mat3, p2: number): Mat3;
        static DivN2(p1: number, p2: Mat3): Mat3;
        ...
        Invert(): void;
        RotateAroundAxisX(angle: number): void;
        RotateAroundAxisY(angle: number): void;
        RotateAroundAxisZ(angle: number): void;
        RotateAroundWorldAxisX(angle: number): void;
        RotateAroundWorldAxisY(angle: number): void;
        RotateAroundWorldAxisZ(angle: number): void;
...
declare namespace RC.Numerics {
    class Mat4 {
        ...
        static Add(p1: Mat4, p2: Mat4): Mat4;
        static AddN(p1: Mat4, p2: number): Mat4;
        static Sub(p1: Mat4, p2: Mat4): Mat4;
        static SubN(p1: Mat4, p2: number): Mat4;
        static SubN2(p1: number, p2: Mat4): Mat4;
        static Mul(m1: Mat4, m2: Mat4): Mat4;
        static MulN(p1: Mat4, p2: number): Mat4;
        static Div(p1: Mat4, p2: Mat4): Mat4;
        static DivN(p1: Mat4, p2: number): Mat4;
        static DivN2(p1: number, p2: Mat4): Mat4;
        Clone(): Mat4;
...
declare namespace RC.Numerics {
    class Vec2 {
        ...
        static Equals(p1: Vec2, p2: Vec2): boolean;
...
declare namespace RC.Numerics {
    class Vec3 {
        ...
        static Equals(p1: Vec3, p2: Vec3): boolean;
