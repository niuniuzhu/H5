namespace RC.Collections {
	...
	*/
	...
	export class Utils {
		 ...
		 * @function
		 */
		public static defaultCompare<T>(a: T, b: T): number {
			if (a < b) {
				return -1;
			} else if (a === b) {
				return 0;
		 ...
		 * @function
		 */
		public static defaultEquals<T>(a: T, b: T): boolean {
			return a === b;
		}
		 ...
		 * @function
		 */
		public static defaultToString(item: any): string {
			if (item === null) {
		...
		*/
		public static makeString<T>(item: T, join: string = ','): string {
			if (item === null) {
				return 'COLLECTION_NULL';
			} else if (Utils.isUndefined(item)) {
				return 'COLLECTION_UNDEFINED';
		 ...
		 * @function
		 */
		public static reverseCompareFunction<T>(compareFunction?: ICompareFunction<T>): ICompareFunction<T> {
		 ...
		 * @function
		 */
		public static compareToEquals<T>(compareFunction: ICompareFunction<T>): IEqualsFunction<T> {
